...
#  23. Создать переменную item_1 в которoй прибавить 10 к переменной int_item
item_1 = int_item + 10
print(item_1)
...
#                     при target_currency_amount и usd_eur_rate.
...
if currency_convertor:
    ...
    # target_currency = str(input("Input currency "))
